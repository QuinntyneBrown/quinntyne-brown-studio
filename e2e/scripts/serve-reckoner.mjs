...
const child = spawn(process.env.RECKONER_DOTNET ?? 'dotnet', [assembly, '--BrowserFixture=Studio'], { windowsHide: true, stdio: 'inherit', env: { ...process.env, ASPNETCORE_ENVIRONMENT: 'Development' } });
