...
public sealed class QualificationRunner(IConfiguration configuration)
{
    ...
    {
        const string usage = "Qbs.Qualification raw|ai|upload|environment --manifest <json> --report <json>. Set adapter configuration through environment variables. Reports never close evidence gates.";
