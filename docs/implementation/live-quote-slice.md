...
Acceptance sources: [API and pricing cases](../../backend/tests/QuinntyneBrownStudio.AcceptanceTests/LiveQuoteAcceptanceTests.cs), [Maps boundary cases](../../backend/tests/QuinntyneBrownStudio.AcceptanceTests/QuoteMapsAcceptanceTests.cs), [SQL reopening case](../../backend/tests/QuinntyneBrownStudio.AcceptanceTests/QuoteSqlAcceptanceTests.cs), [calculator browser cases](../../e2e/specs/live-quote.spec.ts), [multi-cost and keyboard cases](../../e2e/specs/live-quote-completion.spec.ts), and [missing-date validation](../../e2e/specs/live-quote-validation.spec.ts). The existing four-service fixtures and discount/time cases remain regression coverage.
...
| --- | --- |
| Backend Release acceptance | **85 passed, 0 failed, 0 skipped**, including four SQL LocalDB cases; `dotnet test backend/QuinntyneBrownStudio.slnx -c Release`. The slice adds 41 acceptance/adapter cases. |
